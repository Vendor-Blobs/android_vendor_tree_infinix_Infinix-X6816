...
#BSP:add by linanyang for lcm driver 20211220 begin
BOOT_LOGO = hdplus1640
#BSP:add by linanyang for lcm driver 20211220 end
...
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add project macro by wanghanfeng 20211203 start
CUSTOM_BUILD_VERNO = CY-X6816-XQ683-A
#BSP: add project macro by wanghanfeng 20211203 start
...
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw gc08a3_mipi_raw gc6133_serial_yuv pblcs5k3l6_mipi_raw pblcgc08a3_mipi_raw pblcgc6133_serial_yuv
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_mipi_raw
CUSTOM_TRAN_HAL_MAIN2_IMGSENSOR = gc6133_serial_yuv
...
CUSTOM_HAL_SUB_IMGSENSOR = gc08a3_mipi_raw
...
#BSP add by liangjiaqiang sub flashlight for 20211227 start
SR_SUB_FLASHLIGHT_SUPPORT = yes
#BSP add by liangjiaqiang sub flashlight for 20211227 end
#BSP modify KFLJHLEYB-1 [P1 debug] by yilong.luo for 20201109 start
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw gc08a3_mipi_raw gc6133_serial_yuv
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
#BSP modify KFLJHLEYB-1 [P1 debug] by yilong.luo for 20201109 start
CUSTOM_KERNEL_LINEARACCEL_SENSOR = yes
#BSP:modify by linanyang for e-compass driver 20211227 begin
CUSTOM_KERNEL_MAGNETOMETER = yes
#BSP modify KFLJHLEYB-1 [P1 debug] by yilong.luo for 20201109 end
SR_MAGNETOMETER_QMC6308 = yes
SR_MAGNETOMETER_MMC5603 = yes
#BSP:modify by linanyang for e-compass driver 20211227 end
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc08a3_mipi_raw
CUSTOM_KERNEL_TILT_DETECTOR_SENSOR = yes
#BSP:add by linanyang for tp driver 20211220 begin
#CUSTOM_KERNEL_TOUCHPANEL = GT1XX
SR_TOUCHPANEL_OMNIVISION_TCM = yes
SR_TOUCHPANEL_NOVATECH_NT36XXX = yes
#BSP:add by linanyang for tp driver 20211220 end
...
#BSP:modify mic by liangjiaqiang 20211226 begin
MTK_AUDIO_SPEAKER_PATH = int_hp_buf
#BSP:modify mic by liangjiaqiang 20211226 end
...
MTK_BWC_SUPPORT = yes
#BSP:modify md by liangjiaqiang 20211225 start
MTK_C2K_LTE_MODE = 0
#BSP:modify md by liangjiaqiang 20211225 end
MTK_CAMERA_APP = no
...
MTK_HAC_SUPPORT = no
#set audio param. shaoxuesong 2022.1.4 start
MTK_HANDSFREE_DMNR_SUPPORT = no
#set audio param. shaoxuesong 2022.1.4 end
...
#BSP:modify md by liangjiaqiang 20211225 en d
...
#zhaozhigang modify sim_hot_swap 2021-12-20 start
MTK_SIM_HOT_SWAP_COMMON_SLOT = yes 
#zhaozhigang modify sim_hot_swap 2021-12-20 end
...
#modify refresh rate. 2022.0110. shaoxuesong.start
MTK_HIGH_FRAME_RATE = yes
#modify refresh rate. 2022.0110. shaoxuesong.end
...
#modify refresh rate. 2022.03.11. shaoxuesong.start
...
#redmine105559 zhouzihan modified for health.apk 2021-12-20 begin
OS_HEALTH_MODE_SUPPORT = yes
#redmine105559 zhouzihan modified for health.apk 2021-12-20 end

#BSP: add project clone format by wanghanfeng 20211203 start
...
#BSP: add project clone format by wanghanfeng 20211203 end
#SDD: add project sw version by jiangping.guo 20211203 start
#Redmine100563 shaoxuesong modified for base config 2021-12-16 start
MTK_BUILD_VERNO=X6816-XQ683AMNP-R-OP-220507V422
TRAN_FINGERPRINT_BUILD_VERNO=220507V422
#Redmine100563 shaoxuesong modified for base config 2021-12-16 end
#SDD: add project sw version by jiangping.guo 20211203 end
#BSP: add project macro by wanghanfeng 20211203 start
CUSTOM_TRAN_PROJECT=tran_x6816
CUSTOM_TRAN_BOM=tran_x6816_a1
#BSP: add project macro by wanghanfeng 20211203 end
